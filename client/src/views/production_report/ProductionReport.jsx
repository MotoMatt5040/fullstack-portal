					...
					<div className='table-area'>
						<table className='production-report-target-table'>
							...
							<tbody>
								<tr>
									<td colSpan={8}/>
									<td colSpan={2} className='justify-right'><b>Expected LOI:</b></td>
									<td><b>{expectedLoi}</b></td>
									<td/>
									<td><b>X.CPH</b></td>
									<td><b>{expectedCph.toFixed(2)}</b></td>
								</tr>
								...
								<tr>
									...
									<td colSpan={2}/>
									<td>{expectedCph > 0 ? (1 / expectedCph).toFixed(2) : 'div/0'}</td>
								</tr>
								...
								<tr>
									...
									<td>{data.length}</td>
									<td className='justify-right'><b>TODAY'S CMS ACTUAL:</b></td>
									<td>{totalCms}</td>
									<td className='justify-right'>Avg. Daily LOI:</td>
									<td>{dailyLoi}</td>
									<td/>
									<td>A.CPH</td>
									<td className={actualCph >= expectedCph ? 'highlight-green' : 'highlight-red'}>{actualCph}</td>
								...
								<tr>
									...
									<td>{(data.length * .2).toFixed(0)}</td>
									<td className='justify-right'><b>TODAY'S CMS DIFF:</b></td>
									<td className={totalCms - (totalHours * expectedCph).toFixed(0) >= 0 ? 'highlight-rich-green' : 'highlight-red'}>{(totalCms - (totalHours * expectedCph).toFixed(0)).toString()}</td>
									<td className='justify-right'>Avg. Overall LOI:</td>
									<td>{expectedLoi}</td>
									<td/>
									<td>A.MPH</td>
									<td className={amph >= targetMph ? 'highlight-green' : 'highlight-red'}>{amph}</td>
								...
								<tr>
									...
									<td colSpan={4}></td>
									<td className='justify-right'><b>TODAY'S HOURS:</b></td>
									<td>{totalHours}</td>
									<td colSpan={5}>X.CPD = Expected CMS based on dials
									</td>
								</tr>
